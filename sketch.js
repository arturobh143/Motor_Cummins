...
function draw() {
  ...
  textAlign(CENTER);
  text(int(1000+degrees(calcAngle)/360*6000), x, y+r+20);
  }
  ...
  textStyle(BOLD);
  textSize(14);
  text('APERTURA DE VÁLVULA', 615 , -480);
